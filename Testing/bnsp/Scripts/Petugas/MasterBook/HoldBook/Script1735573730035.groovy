...
WebUI.click(findTestObject('Object Repository/Page_Library BNSP/ul_Discover                                _9a86aa'))

WebUI.click(findTestObject('Object Repository/Page_Library BNSP/span_Book'))

WebUI.click(findTestObject('Object Repository/Page_Library BNSP/button_Active_status'))
