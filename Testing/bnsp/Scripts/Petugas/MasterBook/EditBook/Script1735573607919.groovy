...
WebUI.click(findTestObject('Object Repository/Page_Library BNSP/body_MY LIBRARY    Menu                    _ee2924'))

WebUI.setText(findTestObject('Object Repository/Page_Library BNSP/input__book_title'), 'My Book Covers')
