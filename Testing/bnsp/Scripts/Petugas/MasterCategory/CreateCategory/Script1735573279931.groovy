...
WebUI.setText(findTestObject('Object Repository/Page_Library BNSP/input_Category_category_name'), 'bisnis')

WebUI.click(findTestObject('Object Repository/Page_Library BNSP/button_Create'))
