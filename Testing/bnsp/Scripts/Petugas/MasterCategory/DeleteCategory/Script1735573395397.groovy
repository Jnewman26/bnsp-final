...
WebUI.click(findTestObject('Object Repository/Page_Library BNSP/i_motivasi_fad fa-trash text-white'))

WebUI.click(findTestObject('Object Repository/Page_Library BNSP/button_Hapus'))
