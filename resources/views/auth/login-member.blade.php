...
<body class="container" style="background: #F3F9FF">
    ...
    <div class="card border-0 shadow-sm mx-auto rounded-4 p-4" style="width: 50vh; margin-top: 15vh;">
        <div class="card-body">
            <h4 class="text-center fw-semibold mb-5">Sign In Member</h4>
            <form action="{{ route('login.member') }}" method="POST">
                @csrf
                <input class="form-control" type="text" name="member_email" id="member_email" value=""
                ...
                <div class="text-center mt-3">
                    Already have an account? <a href="{{ url('register/member') }}">Register</a>
                </div>
            </form>
        </div>
    </div>
